...
import com.aueb.microwave.databinding.ActivityWarmUpFoodBinding;

import java.util.ArrayList;
import java.util.Arrays;

public class WarmUpFoodActivity extends AppCompatActivity {
    ActivityWarmUpFoodBinding binding;
    String mAnswer;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this,R.layout.activity_warm_up_food);
        ActionBar actionBar;
        ...
        if (mAnswer.equals("όχι")){
            ...
            tts=new TextToSpeech(getApplicationContext(), new TextToSpeech.OnInitListener() {
                ...
                public void onInit(int status) {
                    tts.speak("Το ζέσταμα φαγητού είναι ενάμιση λεπτό, αν θέλετε να συνεχίσετε πείτε εντάξει ή αν θέλετε διαφορετικό χρόνο πείτε τον αριθμό των λεπτών", TextToSpeech.QUEUE_FLUSH,null,null);
                }
            });
        }//spinners
    }
    private void setUpClickListeners() {
        binding.WarmUpFoodBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(WarmUpFoodActivity.this, TimerActivity.class);
                timeMin = "01";
                timeSec = "30";
                String mAnswer = "όχι";
        ...
        binding.backBtn.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WarmUpFoodActivity.this, FoodActivity.class);
                String mAnswer = "όχι";
                intent.putExtra("ANSWER",mAnswer);
                intent.putExtra("TIME_MIN", timeMin);
                intent.putExtra("TIME_SEC", timeSec);
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        Intent myIntent = new Intent(WarmUpFoodActivity.this, FoodActivity.class);
    ...
    private String spinnerMin() {
        ...
        /*String[] items = new String[]{"00", "01", "02", "03", "04", "05", "06", "07", "08", "09", "10",
        ...
        dropdownMin.setOnItemSelectedListener ( new AdapterView.OnItemSelectedListener () {
            ...
            public  void onItemSelected (AdapterView <?> parent, View view, int position, long id) {
                timeMin = parent.getItemAtPosition(position).toString();
            }
    ...
    private void startSpeechRecognizer() {
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                intent.putExtra(RecognizerIntent.EXTRA_PROMPT,"Τι ρόφημα θα θέλατε να ζεστάνετε;");
        ...
        if (requestCode == 3000 && resultCode == Activity.RESULT_OK && data != null){
            ...
            switch (mAnswer.toLowerCase()){
                case "εντάξει" :
                    ...
                    timeMin = "01";
                    timeSec = "30";
                    intent = new Intent(WarmUpFoodActivity.this, TimerActivity.class);
                    intent.putExtra("ANSWER", mAnswer);
                    intent.putExtra("TIME_MIN",timeMin);
                    intent.putExtra("TIME_SEC",timeSec);
                    startActivity(intent);
                ...
                case "πίσω":
                    answer_id=3;
                    mAnswer = "ναι";
                    intent = new Intent(WarmUpFoodActivity.this, FoodActivity.class);
                    intent.putExtra("ANSWER", mAnswer);
                    startActivity(intent);
                    break;
                default:
                    ...
                    answer_id=0;
                    timeSec = "00";
                    intent = new Intent(WarmUpFoodActivity.this, ChooseSecondsActivity.class);
                    if (timeMin == "λάθος"){
    ...
    public void findMinSec(int requestCode, int resultCode,
                           Intent data){
        super.onActivityResult(requestCode, resultCode, data);
        Intent intent;
        Log.i("DEMO-REQUESTCODE", Integer.toString(requestCode));
        Log.i("DEMO-RESULTCODE", Integer.toString(resultCode));
        if (requestCode == 3000 && resultCode == Activity.RESULT_OK && data != null) {
            ArrayList<String> newtext2 = data
                    .getStringArrayListExtra(RecognizerIntent.EXTRA_RESULTS);
            intent = new Intent(WarmUpFoodActivity.this, TimerActivity.class);
            ArrayList<String> newtext3 = data
                    .getStringArrayListExtra(RecognizerIntent.EXTRA_RESULTS);
            tts.speak("Πείτε τον αριθμό των λεπτών", TextToSpeech.QUEUE_FLUSH, null, null);
            timeMin = newtext2.get(0);
            tts.speak("Πείτε τον αριθμό των δευτερολέπτων", TextToSpeech.QUEUE_FLUSH, null, null);
            timeSec = newtext3.get(0);
            intent.putExtra("TIME_MIN", timeMin);
            intent.putExtra("TIME_SEC", timeSec);
            intent.putExtra("ANSWER", mAnswer);
            startActivity(intent);
