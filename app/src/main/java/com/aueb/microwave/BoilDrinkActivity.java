...
import com.aueb.microwave.databinding.ActivityBoilDrinkBinding;

import java.util.ArrayList;
import java.util.Arrays;

public class BoilDrinkActivity extends AppCompatActivity {
    ActivityBoilDrinkBinding binding;
    String mAnswer;
    TextToSpeech tts;
    String timeMin = "00";
    String timeSec = "00";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this,R.layout.activity_boil_drink);
        ActionBar actionBar;
        actionBar = getSupportActionBar();
        // color the action bar light red
        ColorDrawable colorDrawable
                = new ColorDrawable(Color.parseColor("#F37C7B"));

        actionBar.setBackgroundDrawable(colorDrawable);
        //actionBar.setDisplayHomeAsUpEnabled(true); // action bar arrow enabled
        ...
        if (mAnswer.equals("όχι")){
            ...
            tts=new TextToSpeech(getApplicationContext(), new TextToSpeech.OnInitListener() {
                ...
                public void onInit(int status) {
                    tts.speak("Τι θα θέλατε να βράσετε; Απαντήστε με γάλα ή νερό."+
    ...
    private void setUpClickListeners() {
        binding.BoilMilkBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BoilDrinkActivity.this, TimerActivity.class);
                timeMin = "02";
                timeSec = "30";
                String mAnswer = "όχι";
        ...
        binding.BoilWaterBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BoilDrinkActivity.this, TimerActivity.class);
                timeMin = "02";
        ...
        binding.backBtn.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BoilDrinkActivity.this, DrinkActivity.class);
                String mAnswer = "όχι";
                intent.putExtra("ANSWER",mAnswer);
                intent.putExtra("TIME_MIN", timeMin);
                intent.putExtra("TIME_SEC", timeSec);
    ...
    // ActionBar: Go back to the previous activity
    public boolean onOptionsItemSelected(MenuItem item){
        Intent myIntent = new Intent(BoilDrinkActivity.this, DrinkActivity.class);
    ...
    private void startSpeechRecognizer() {
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                intent.putExtra(RecognizerIntent.EXTRA_PROMPT,"Τι θα θέλατε να βράσετε;");
    ...
    public void onActivityResult(int requestCode, int resultCode,
        ...
        if (requestCode == 3000 && resultCode == Activity.RESULT_OK && data != null){
            ...
            switch (mAnswer.toLowerCase()){
                case "γάλα" :
                    answer_id=1;
                    intent = new Intent(BoilDrinkActivity.this, TimerActivity.class);
                    timeMin = "02";
                    timeSec = "30";
                    intent.putExtra("ANSWER", mAnswer);
                    intent.putExtra("TIME_MIN", timeMin);
                ...
                case "πίσω":
                    answer_id=3;
                    mAnswer = "ναι";
                    intent = new Intent(BoilDrinkActivity.this, DrinkActivity.class);
                    intent.putExtra("ANSWER", mAnswer);
                    startActivity(intent);
                    break;
                default:
                    ...
                    answer_id=0;
                    timeSec = "00";
                    intent = new Intent(BoilDrinkActivity.this, ChooseSecondsActivity.class);
                    if (timeMin == "λάθος"){
