...
import com.aueb.microwave.databinding.ActivityWarmUpDrinkBinding;

import java.util.ArrayList;
import java.util.Arrays;

public class WarmUpDrinkActivity extends AppCompatActivity {
    ActivityWarmUpDrinkBinding binding;
    String mAnswer;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this,R.layout.activity_warm_up_drink);
        ActionBar actionBar;
        ...
        if (mAnswer.equals("όχι")){
            ...
            tts=new TextToSpeech(getApplicationContext(), new TextToSpeech.OnInitListener() {
                ...
                public void onInit(int status) {
                    tts.speak("Τι ρόφημα θα θέλατε να ζεστάνετε; Απαντήστε με γάλα ή νερό ή σοκολάτα." +
    ...
    private void setUpClickListeners() {
        binding.WarmUpChocolateBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WarmUpDrinkActivity.this, TimerActivity.class);
                timeMin = "02";
                timeSec = "00";
                mAnswer = "όχι";
        ...
        binding.WarmUpMilkBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WarmUpDrinkActivity.this, TimerActivity.class);
                timeMin = "01";
        ...
        binding.WarmUpWaterBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WarmUpDrinkActivity.this, TimerActivity.class);
                timeMin = "00";
        ...
        binding.backBtn.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WarmUpDrinkActivity.this, DrinkActivity.class);
                String mAnswer = "όχι";
                intent.putExtra("ANSWER",mAnswer);
                intent.putExtra("TIME_MIN", timeMin);
                intent.putExtra("TIME_SEC", timeSec);
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        Intent myIntent = new Intent(WarmUpDrinkActivity.this, DrinkActivity.class);
        ...
        if (requestCode == 3000 && resultCode == Activity.RESULT_OK && data != null){
            ...
            switch (mAnswer.toLowerCase()){
                case "γάλα" :
                    ...
                    timeMin = "01";
                    timeSec = "00";
                    intent = new Intent(WarmUpDrinkActivity.this, TimerActivity.class);
                    intent.putExtra("ANSWER", mAnswer);
                    intent.putExtra("TIME_MIN", timeMin);
                    intent.putExtra("TIME_SEC", timeSec);
                    startActivity(intent);
                ...
                case "πίσω":
                    answer_id=3;
                    mAnswer = "ναι";
                    intent = new Intent(WarmUpDrinkActivity.this, DrinkActivity.class);
                    intent.putExtra("ANSWER", mAnswer);
                    startActivity(intent);
                    break;
                default:
                    ...
                    answer_id=0;
                    timeSec = "00";
                    intent = new Intent(WarmUpDrinkActivity.this, ChooseSecondsActivity.class);
                    if (timeMin == "λάθος"){
