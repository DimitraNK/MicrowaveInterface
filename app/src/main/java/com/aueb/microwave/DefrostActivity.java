...
import com.aueb.microwave.databinding.ActivityDefrostBinding;

import java.util.ArrayList;
import java.util.Arrays;

public class DefrostActivity extends AppCompatActivity {
    ActivityDefrostBinding binding;
    String mAnswer;
    TextToSpeech tts;
    String timeMin = "00";
    String timeSec = "00";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_defrost);
        ActionBar actionBar;
        ...
        if (mAnswer.equals("όχι")){
            ...
            tts=new TextToSpeech(getApplicationContext(), new TextToSpeech.OnInitListener() {
                ...
                public void onInit(int status) {
                    tts.speak("Τι θα θέλατε να αποψύξετε; Απαντήστε με κρέας ή κοτόπουλο ή θαλασσινά."+
    ...
    private void setUpClickListeners() {
        binding.DefrostMeatBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DefrostActivity.this, TimerActivity.class);
                timeMin = "13";
                timeSec = "00";
                mAnswer = "όχι";
        ...
        binding.DefrostPoultryBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DefrostActivity.this, TimerActivity.class);
                timeMin = "11";
        ...
        binding.DefrostSeaFoodBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DefrostActivity.this, TimerActivity.class);
                timeMin = "07";
        ...
        binding.backBtn.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DefrostActivity.this, FoodActivity.class);
                String mAnswer = "όχι";
                intent.putExtra("ANSWER",mAnswer);
                intent.putExtra("TIME_MIN", timeMin);
                intent.putExtra("TIME_SEC", timeSec);
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        Intent myIntent = new Intent(DefrostActivity.this, FoodActivity.class);
    ...
    private void startSpeechRecognizer() {
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                intent.putExtra(RecognizerIntent.EXTRA_PROMPT,"Τι θα θέλατε να αποψύξετε;");
        ...
        if (requestCode == 3000 && resultCode == Activity.RESULT_OK && data != null){
            ...
            switch (mAnswer.toLowerCase()){
                case "κρέας" :
                    ...
                    timeMin = "13";
                    timeSec = "00";
                    intent = new Intent(DefrostActivity.this, TimerActivity.class);
                    intent.putExtra("ANSWER", mAnswer);
                    intent.putExtra("TIME_MIN", timeMin);
                    intent.putExtra("TIME_SEC", timeSec);
                    startActivity(intent);
                ...
                case "πίσω":
                    answer_id=3;
                    mAnswer = "ναι";
                    intent = new Intent(DefrostActivity.this, FoodActivity.class);
                    intent.putExtra("ANSWER", mAnswer);
                    startActivity(intent);
                    break;
                default:
                    ...
                    answer_id=0;
                    timeSec = "00";
                    intent = new Intent(DefrostActivity.this, ChooseSecondsActivity.class);
                    if (timeMin == "λάθος"){
